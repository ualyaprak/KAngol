...
if ( !class_exists( 'Simple_Map' ) ) {
	...
	class Simple_Map {
		...
		function location_search_form( $atts ) {
			...
			$ffi['city']		= array( 'label' => apply_filters( 'sm-search-label-city', __( 'City: ', 'SimpleMap' ), $post ), 'input' => '<input type="text"  id="location_search_city_field" name="location_search_city" value="' . esc_attr( $city_value ) . '" /><br/><br/> OR' );
			...
			$ffi['zip']			= array( 'label' => apply_filters( 'sm-search-label-zip', __( 'Postal Code / Zip: ', 'SimpleMap' ), $post ), 'input' => '<input type="text" id="location_search_zip_field" name="location_search_zip" value="' . esc_attr( $zip_value ) . '" />' );
			...
			$location_search .= '<tr><td colspan="' . $search_form_cols . '" class="location_search_title">' . apply_filters( 'sm-location-search-title', 'Search by:', $post->ID ) . '</td></tr>';
		...
		function get_default_shortcode_atts() {
			...
			$atts = $tax_atts + array(
				...
				'search_form_cols'			=> 1, 
				'search_fields'				=> 'labelbr_city||labelbr_zip||empty||empty||labeltd_distance||empty' . implode('', $tax_search_fields) . '||submit||empty||empty', 
